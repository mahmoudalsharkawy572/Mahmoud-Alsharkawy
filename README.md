<h1 align="center">Hi, I'm Mahmoud Al-Sharkawy 👋</h1>

<p align="center">
  <b>.NET Backend Developer</b> · Computer Engineering · Clean Architecture Enthusiast
</p>

<p align="center">
  <a href="https://www.linkedin.com/in/mahmoud-alsharkawy-a77bb3223" target="_blank">
...
![Clean Architecture](https://img.shields.io/badge/Clean_Architecture-0e75b6?style=flat-square)
![CQRS](https://img.shields.io/badge/CQRS-0e75b6?style=flat-square)
![REST API](https://img.shields.io/badge/REST_API-0e75b6?style=flat-square)
...
A full-featured multi-vendor marketplace backend built as a technical assessment.
...
A food ordering platform with basket management and a full order lifecycle.
...
### 🏡 Royal Villa Booking Platform
A villa booking system with a dedicated REST API and a separate ASP.NET Core MVC frontend.
...
### 📚 BulkyBook Web — MVC
An ASP.NET Core MVC web application for managing and purchasing books, following industry-standard MVC patterns.
...
### 🍽️ Restaurants API
A restaurant management system for handling restaurants, menus, and dishes with structured logging and role-based access.

- **Stack:** ASP.NET Core 8 · EF Core · SQL Server · MediatR · FluentValidation · AutoMapper · Serilog · ASP.NET Identity
- **Architecture:** Clean Architecture (Domain / Application / Infrastructure / API)
- **Highlights:** Full CQRS pattern via MediatR, request time logging middleware, global error handling middleware, email confirmation & 2FA support, Swagger/OpenAPI docs
- 🔗 [View Repository](https://github.com/mahmoudalsharkawy572/Restaurants)

---

### 🖥️ Vision-Based Desktop Automation
An AI-powered desktop automation agent inspired by the ScreenSpot-Pro architecture.
...
<p align="center">
  <i>Open to junior / entry-level .NET Backend roles — feel free to reach out!</i>
</p>
